...
test('workspace with no response type nodes returns empty array of node ids', () => {
    let testSkill = {"name": "test skill", "intents": [{"intent": "first_intent", "examples": []}, {"intent": "third_intent", "examples": []}, {"intent": "second_intent", "examples": []}], "dialog_nodes": [
        {
        "type": "standard",
        "title": "A node",
    ...
    expect(new NoDisabledResponses(testSkill).run().nodeIds).toEqual([]);
})

test('workspace with no disabled response type nodes returns empty array of node ids', () => {
    let testSkill = {"name": "test skill", "intents": [{"intent": "first_intent", "examples": []}, {"intent": "third_intent", "examples": []}, {"intent": "second_intent", "examples": []}], "dialog_nodes": [
        {
        "type": "response_condition",
        "title": "A node",
...
test('workspace with one disabled response type nodes returns array of that node id', () => {
    let testSkill = {"name": "test skill", "intents": [{"intent": "first_intent", "examples": []}, {"intent": "third_intent", "examples": []}, {"intent": "second_intent", "examples": []}], "dialog_nodes": [
        {
        "type": "response_condition",
        "title": "A node",
    ...
    expect(new NoDisabledResponses(testSkill).run().nodeIds).toEqual(['node_1212']);
})

test('workspace with multiple disabled response type nodes returns array of all those node ids', () => {
    let testSkill = {"name": "test skill", "intents": [{"intent": "first_intent", "examples": []}, {"intent": "third_intent", "examples": []}, {"intent": "second_intent", "examples": []}], "dialog_nodes": [
        {
        "type": "response_condition",
        "title": "A node",
        ...
        "metadata": {},
        "conditions": "$maybe == true",
        "dialog_node": "response_1875"}]};

    expect(new NoDisabledResponses(testSkill).run().nodeIds.sort()).toEqual(["response_1432", "node_1212", "response_1875"].sort());
})